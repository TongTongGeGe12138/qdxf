<template>
    <div class="smart-computing-container" :style="{ background: bannerBgColor }">
        <div class="title" :style="{ color: menuTextColor }">团队协作</div>
        <div class="banner-box" :style="{ background: cardBgColor, borderColor: borderColor }">
            <img class="banner-img" :src="bannerImg" alt="智能计算banner" />
            <div class="banner-content">
                ...
                <el-button type="warning" @click="handleApply" class="launch-btn">申请体验</el-button>
            </div>
        </div>
    </div>
    ...
    >
        <p style="text-align: left;">申请成功，团队协作功能开放后将第一时间通知您。</p>
        <template #footer>
...
const handleApplyConfirm = () => {
    ...
    // ElMessage.success('申请成功，智能计算功能开放后将第一时间通知您。')
}
</script>
